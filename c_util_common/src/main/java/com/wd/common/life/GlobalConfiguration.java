...
import com.wd.common.BuildConfig;
import com.wd.common.http.GlobalHttpHandlerImpl;
import com.wd.common.http.ResponseErrorListenerImpl;
import com.wd.common.http.SSLSocketClient;
import com.wd.common.imgaEngine.Strategy.CommonGlideImageLoaderStrategy;
import com.wd.common.service.Api;
        ...
        if (!BuildConfig.LOG_DEBUG) //Release 时,让框架不再打印 Http 请求和响应的信息
            builder
                    ...
                    .okhttpConfiguration((context12, builder1) -> {
                        builder1.sslSocketFactory(SSLSocketClient.getSSLSocketFactory(),
